                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              child: const Text('Marathon Skills 2023',
                                  style: TextStyle(
                          ...
                          child: ElevatedButton(
                              style: ButtonStyle(
                                  ...
                                  padding: MaterialStateProperty.all(
                                      EdgeInsets.all(5))),
                              onPressed: () {
                                Navigator.pushNamed(context, '/how_long');
                              },
                              child: const Text('Насколько долгий марафон',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black))),
                        ),
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              child: const Text('Предыдущие результаты',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black))),
                        ),
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(context, '/blago_org13');
                              },
                              child: const Text('Благотворительные организации',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              child: const Text('BMI калькулятор',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black))),
                        ),
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              child: const Text('BMR калькулятор',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black))),
                        ),
                      ])),
