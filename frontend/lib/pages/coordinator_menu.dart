...
class CoordinatorMenuScreen extends StatelessWidget {
  const CoordinatorMenuScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AuthCheckerWidget(
      isAllowed: SessionData.isUserCoordinator(),
                      ...
                      children: [
                          ...
                          child: ElevatedButton(
                              style: ButtonStyle(
                                  ...
                                  padding: MaterialStateProperty.all(
                                      EdgeInsets.all(5))),
                              onPressed: () {
                                Navigator.pushNamed(context, '/sponsor_view');
                              },
                              child: const Text('Спонсоры',
                                  style: TextStyle(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(
                                    context, '/control_runners');
                              },
                              child: const Text('Бегуны',
                                  style: TextStyle(
                                      fontSize: 25, color: Colors.black))),
                        ),
                      ],
